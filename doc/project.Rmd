...
abstract: |
  ...
  **Methods —** The *Lanzas* model was modified to include fecal transplant, in addition to antibiotic therapy, as treatment for *C.  difficile* infection (CDI). To incorporate fecal transplant, we altered the original model in two primary ways: (1) Collapse of the two asymptomatically colonized states, C^+^ and C^-^ (with and without protection against CDI, respectively), into a single colonized state, C; and (2) Expansion of the single “susceptible to colonization” state, S, into separate compartments: “susceptible to colonization following antibiotic treatment” (S~a~) and “susceptible to colonization following fecal transplant” (S~f~). The modified model includes five possible transition states: resistant to colonization (R), susceptible to colonization following antibiotic therapy (S~a~), susceptible to colonization following fecal transplant (S~f~), asymptomatically colonized (C), and patients with symptomatic disease (D). The new parameters to reflect fecal transplant-associated transition rates between compartments were derived from the literature.
output: pdf_document
...
exposure (@thomas,@hensgens). Moreover, both asymptomatically colonized
...
survive for long periods as fomites and are not killed by alcohol-based
...
patient-patient transmission to *C. difficile* burden in hospital
...
gut bacterial diversity and resolves diarrhea symptomology nearly
...
to unclear significance of “immune protection” against *C. difficile*
...
disease (D) (**Figure 1**). The addition of new parameters to reflect
...
coefficient of infectious (asymptomatically colonized or diseased)
...
diarrhea during a 10-day treatment course (McFarland 2008). Therefore,
...
also varied fecal transplant parameters of interest and re-generated
...
in an open hospital population of ward size 20, assumed consistent with
literature estimates that all symptomatic *C. difficile* patients are
...
observed reductions in R0 observed in our deterministic models.
...
compartment due to inadequate support in the published literature to
support a “colonized with immune protection” compartment. We recognize,
...
distribution of final epidemic sizes, in both populations with and
...
both advances in disinfection and treatment (fecal transplant) since
original that affect *C. difficile* transmission dynamics.
