...
more than \$1 billion (@miller_chen, @dubberke_olsen_2012, @magill_edwards).
...
and are not killed by alcohol-based hand sanitizers (@wilcox). For these reasons, inter-patient spread and CDI outbreaks are
...
recurrence rates following treatment are high (@austin-matthew).
...
has cured recurrent or refractory CDI in \> 90% of patients (@austin-matthew).
...
diversity and resolves diarrhea symptomology nearly immediately (@bakken-johan). These effects fundamentally alter patient
