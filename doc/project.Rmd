...
best.attack.rate <- stochastic.sim(param, initial.state,
                                   stochastic.dx.dt.new, simulations)
```
...
original model and new model respectively. We also computed a "base case
scenario" model for the Fecal-Transplant model, with parameters 
(put in paramters!) and saw an attack rate of
`r best.attack.rate[2]` (95% ci `r best.attack.rate[c(1, 3)]`)
