...
`r calc.R0(30, param)`, using a ward size of 30 which is similar to what was 
done in @lanzas.
...
print("theta.ft")
for (theta.temp in c(0.063, 1.5, 2.0)) {
    param["theta.ft"] <- theta.temp
    print(calc.R0(30, param))
    param["theta.ft"] <- theta.ft.old
}
```
